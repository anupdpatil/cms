...
<!--                                    <div class="col"style="padding-left: 1%">
                                        <div class="col-sm-3">
                                            <button class="btn btn-primary" onclick="">Admission Form</button>
                                        </div>
                                        <div class="col-sm-3">
                                            <button class="btn btn-primary" onclick="">Other Receipt Form</button>
                                        </div>
                                        <div class="col-sm-3">
                                            <button class="btn btn-success">List of Admissions</button>
                                        </div>
                                        <div class="col-sm-3">
                                            <button class="btn btn-warning">List of Students</button>
                                        </div>
                                    </div>-->
...
<!--                                        <div class="space-6"></div>
                                        ...
                                        <div class="infobox infobox-green">
                                            ...
                                            <div class="infobox-data">
                                                ...
                                                <div class="infobox-content">Staff Members</div>
                                            </div>
                                        ...
                                        <div class="infobox infobox-orange2">
                                            ...
                                            <div class="infobox-data">
                                                <span class="infobox-data-number"><?php echo count(scandir(ini_get("session.save_path"))) - 2; ?></span>
                                        ...
                                        <div class="infobox infobox-grey">
                                            ...
                                            <div class="infobox-data">
                                                ...
                                                <div class="infobox-content">Available Courses</div>
                                            </div>
                                        </div>
                                        <div class="infobox infobox-red">
                                            ...
                                            <div class="infobox-data">
                                                ...
                                                <div class="infobox-content"><i class="ace-icon fa fa-male"></i>600 | <i class="ace-icon fa fa-female"></i>500</div>
                                            </div>
                                        </div>
                                        <div class="infobox infobox-blue">
                                            ...
                                            <div class="infobox-data">
                                                <span class="infobox-data-number">Admissions</span>
                                                <div class="infobox-content">Paying: 600 | GOI: 500</div>
                                            </div>
                                        </div>
                                        <div class="infobox infobox-pink">
                                            ...
                                            <div class="infobox-data">
                                                <span class="infobox-data-number">DCR</span>
                                                <div class="infobox-content"><i class="ace-icon fa fa-inr"></i>500/-</div>
                                            </div>
                                        </div>
                                        <div class="space-6"></div>
                                        <div class="space-6"></div>
                                        ...
                                        <div class="infobox infobox-green infobox-small infobox-dark">
                                            ...
                                            <div class="infobox-data">
                                                <div class="infobox-content">Academics</div>
                                                <div class="infobox-content">2022-23</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="infobox infobox-orange2 infobox-small infobox-dark">
                                            ...
                                            <div class="infobox-data">
                                                ...
                                                <div class="infobox-content"><span><i class="ace-icon fa fa-inr"></i></span>32,000</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="infobox infobox-blue2 infobox-small infobox-dark">
                                            ...
                                            <div class="infobox-data">
                                                <div class="infobox-content">Admissions</div>
                                                <div class="infobox-content">12 (Today)</div>
                                            </div>
                                        </div>
                                        <div class="infobox infobox-grey infobox-small infobox-dark">
                                            ...
                                            <div class="infobox-data">
                                                <div class="infobox-content">Other Fee</div>
                                                <div class="infobox-content">5 (Today)</div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    ...
                                                    <div class="clearfix">
                                                        ...
                                                        <div class="grid3">
                                                            <span class="grey">
                                                                <i class="ace-icon fa fa-female fa-2x purple"></i>
                                                                Female
                                                            </span>
...
//                    {label: "other", data: 10}
                ...
                request.done(function (msg) {
                    ...
                    var counts = obj.reduce((p, c) => {
                      var name = c.course_group;
