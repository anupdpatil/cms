...
for ($index = 0; $index < count($data); $index++) {
    if (!empty($data[$index])) {
        ...
        for ($i = 0; $i < count($fees_arr); $i++) {
            ...
            } else if (($fees_arr[$i]->header == 'YUVA RANG/YOUTH FESTIVEL') || (property_exists($invoice_arr, 'YUVA_RANG/YOUTH_FESTIVEL'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'IDENTITY FEE') || (property_exists($invoice_arr, 'IDENTITY_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'ASHWAMEDH FEE') || (property_exists($invoice_arr, 'ASHWAMEDH_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'COLLEGE DEVELOPMENT FUND FEE') || (property_exists($invoice_arr, 'COLLEGE_DEVELOPMENT_FUND_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'COLLEGE DEVELOPMENT FUND') || (property_exists($invoice_arr, 'COLLEGE_DEVELOPMENT_FUND'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'COMPUTERIZATION FEE') || (property_exists($invoice_arr, 'COMPUTERIZATION_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'STUDENTS GROUP INS (UNI) FEE') || (property_exists($invoice_arr, 'STUDENTS_GROUP_INS_(UNI)_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'STUDENTS GROUP INS (UNI)') || (property_exists($invoice_arr, 'STUDENTS_GROUP_INS_(UNI)'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'LABORATORY FEE') || (property_exists($invoice_arr, 'LABORATORY_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'STUDENTS ACTIVITY FEE') || (property_exists($invoice_arr, 'STUDENTS_ACTIVITY_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'POOR STUD AID FUND') || (property_exists($invoice_arr, 'POOR_STUD_AID_FUND'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'GYMKHANA FEE') || (property_exists($invoice_arr, 'GYMKHANA_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'MEDICAL FEE') || (property_exists($invoice_arr, 'MEDICAL_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'LIBRARY FEE') || (property_exists($invoice_arr, 'LIBRARY_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'ADMISSION FFE') || (property_exists($invoice_arr, 'ADMISSION_FFE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } else if (($fees_arr[$i]->header == 'ADMISSION FEE') || (property_exists($invoice_arr, 'ADMISSION_FEE'))) {
                array_push($tutuion_fees, $fees_arr[$i]->value);
            } 
            else {
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs breadcrumbs-fixed  invisible-row" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Detailed Fees Report</li>
                        </ul>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="row invisible-row">
                                    <div class="form-group col-xs-3">
                                        ...
                                        <select name="course_group" id="course"  class="col-sm-8" onchange="getData()">
                                ...
                                <div class="table-header">
                                    Paid And Outstanding Fees Report (Detailed)
                                    <?php
                                    if (isset($_GET['course'])) {
                                        echo ' For ';
                                        ?>
                                        <span id="selceted_course"></span>
                                        <?php
                                    }
                                    ?>
                                                ...
                                                if (isset($data)) {
                                                    ...
                                                    for ($index = 0; $index < count($data); $index++) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if (($_SESSION['user'] == "Anup Patil")) { ?>
                                                                <td><?php echo $data[$index]['invoice_date']; ?></td>
                                                            <?php } ?>
...
//                                                                        echo $tutuion_fees[$index];
                                                                ...
                                                                echo $total_of_row . '<hr style="margin-top: 2px!important; margin-bottom: 2px!important; border-top: 1px solid gray;">';
...
//                                            function selectDate() {
//                                                if ($('#course').val() && $('#date_range_from').val() && ($('#date_range_to').val()))
//                                                    window.location.replace("?course_group=" + $('#course').val());
//                                            }
