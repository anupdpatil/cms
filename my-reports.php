                                    ...
                                    <div class="invisible-row" style="padding: 10px;">
                                        <form class="form-inline">
                                            <div class="form-group mx-sm-3 mb-2">
                                                ...
                                                <select name="course_group" id="course_group" onchange="selectDate()">
                                            ...
                                            <div class="form-group mb-2 col-sm-offset-1">
...
<![endif]-->
        ...
        <script type="text/javascript">
                                            function getData() {
                                                if ($('#date_range').val())
                                                    window.location.replace("?course_group=" + $('#course_group').val() + "&date=" + $('#date_range').val());
                                            }
//                                                    function selectDate() {
//                                                        if ($('#course_group').val())
//                                                            window.location.replace("?course=" + $('#course_group').val() + "&date=" + $('#date_range').val());
//                                                    }
                                            function selectDate() {
                                                if ($('#course_group').val() && $('#date_range_from').val() && ($('#date_range_to').val()))
                                                    window.location.replace("?course_group=" + $('#course_group').val() + "&date_from=" + $("#date_range_from").val() + "&date_to=" + $("#date_range_to").val());
                                            }
