...
$user_data = [];
    ...
    $link = config();
$sql = "SELECT DISTINCT course_group from course";
$result = [];
...
<html lang="en">
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <select name="course_group" id="course"  class="col-xs-10 col-sm-2" onchange="getData()">
                                            <?php for ($index = 0; $index < count($result); $index++) { ?>
                                                <?php if ($result[$index]['course_group'] == $_GET['course_group']) { ?>
                                                    <option selected="true" value="<?php echo $result[$index]['course_group']; ?>"><?php echo $result[$index]['course_group']; ?></option>
                                                <?php } else { ?>
                                                    <option value="<?php echo $result[$index]['course_group']; ?>"><?php echo $result[$index]['course_group']; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
    <!--                                    <select name="course" id="course"  class="col-xs-10 col-sm-2" onchange="getData()">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Record From: </label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Record to: </label>
                                        <div class="col-sm-3">
                                            <div class="input-group">
        ...
        <script type="text/javascript">
                                                    function getData() {
                                                        if ($('#course').val() && $('#date_range_from').val() && ($('#date_range_to').val()))
                                                            window.location.replace("?course_group=" + $('#course').val() + "&date_from=" + $('#date_range_from').val() + "&date_to=" + $('#date_range_to').val());
                                                    }
                                                    function selectDate() {
                                                        if ($('#course').val() && $('#date_range_from').val() && ($('#date_range_to').val()))
                                                            window.location.replace("?course_group=" + $('#course').val() + "&date_from=" + $('#date_range_from').val() + "&date_to=" + $('#date_range_to').val());
