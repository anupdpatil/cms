...
if (!empty($_POST)) {
    ...
    if (mysqli_query($link, $sql)) {
        ...
        if ($_SERVER['SERVER_NAME'] == 'localhost')
            header("Location: http://localhost/acsc/edit-invoice.php");
        else
            header("Location: http://" . $url . "/edit-invoice.php");
    } else {
                                    ...
                                    <div class="col-xs-12">
                                        <form action="" method="post" class="form-horizontal" role="form" id="invoice_form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="invoice_number" type="text" id="invoice_number" placeholder="invoice number"/>
                                                    <textarea name="invoice_details" rows="15" cols="80" id="myTextArea" ></textarea>
                                                </div>
                                            </div>
