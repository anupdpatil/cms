...
if ((isset($_GET['group'])) && isset($_GET['date_from']) && isset($_GET['date_to'])) {
    ...
    array_push($all_headers, 'RE-ADMISSION FEE');
    array_push($all_headers, 'READMISSION FEE');
    array_push($all_headers, 'FACULTY CHANGE FEE');
    array_push($all_headers, 'COLLEGE CHANGE FEE');
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs breadcrumbs-fixed  invisible-row" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Summary DCR Report</li>
                        </ul>
                    </div>
