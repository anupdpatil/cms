...
$sql = "SELECT "
        . "a.id,a.active_class,a.first_name, a.middle_name, a.last_name,"
        . "c.course_name, "
        . "a.gender,"
        . "a.active_roll_number,"
        . "a.category,"
        . "a.email,"
        . "a.created_by,"
        . "a.category "
        . "FROM students a JOIN course c on c.id=a.active_class AND a.active_roll_number > 0"
        . "$clause";
$result = [];
                            ...
                            <div class="col-xs-12">
                                <div class="invisible-row">
                                    <form class="form-inline">
                                        ...
                                        <div class="form-group mx-sm-3 mb-2">
                                            <label style="margin-left: 16px;"class="col m-l-1" for="course">Name Format: </label>
                                            <select name="name_format" id="name_format" onchange="getData()">
                                                <option <?php if ($name_format == 1) { ?>selected="true"<?php }?> value="1"><?php echo "First Name -> Middle Name -> Last Name"; ?></option>
                                                <option <?php if ($name_format==2) { ?>selected="true" <?php } ?> value="2"><?php echo "Last Name -> First Name -> Middle Name"; ?></option>
                                            </select>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                for ($index = 0; $index < count($result); $index++) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php if (($_SESSION['user'] == 'Jayram Chaudhari') || ($_SESSION['user'] == 'Anup Patil')) { ?>
                                                            ...
                                                            <?php if($name_format==1){?>
                                                            <td>
                                                                <?php echo $result[$index]['first_name'] . " " . $result[$index]['middle_name'] . " " . $result[$index]['last_name']; ?>
                                                            </td>
                                                            <?php } else{ ?>
                                                            <td>
                                                                <?php echo $result[$index]['last_name'] . " " . $result[$index]['first_name'] . " " . $result[$index]['middle_name']; ?>
                                                            </td>
                                                            <?php } ?>
                                                        <td>
                                                            <?php echo $result[$index]['course_name']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $result[$index]['gender']; ?>
                                                        </td>
                                                        <td class="hidden-480">
                                                            <?php echo $result[$index]['active_roll_number']; ?>
                                                        </td>
                                                        <td class="hidden-480">
                                                            <?php echo $result[$index]['category']; ?>
                                                        </td>
                                                    </tr>
                                                <?php }
                                                ?>
...
<![endif]-->
        ...
        <script type="text/javascript">
                                                                    function confirmDelete(student_id) {
                                                                        ...
                                                                        if (r == true) {
                                                                            window.location.replace("update-student-details.php?id=" + student_id);
                                                                        }
                                                                    }
                                                                    function getData() {
                                                                        var url = '';
                                                                        ...
                                                                        if ($('#name_format').val()) {
                                                                            url += 'name_format=' + $('#name_format').val() + "&";
                                                                            url_created = true;
                                                                        }
                                                                        if ($('#fee_type').val()) {
