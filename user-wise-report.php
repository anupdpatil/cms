...
if (isset($_GET['course']) && isset($_GET['user'])) {
        $link = config();
    $sql = "SELECT ad.*,
        cr.fees_breakup, 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <select name="user" id="user"  class="col-xs-10 col-sm-2" onchange="getData()">
                                        <option value=""> Please Select User </option>
                                        <?php for ($index = 0; $index < count($users); $index++) { ?>
                                            <?php if ($users[$index]['first_name'] . ' ' . $users[$index]['last_name'] == $_GET['user']) { ?>
                                                <option selected="true" value="<?php echo $users[$index]['first_name'] . ' ' . $users[$index]['last_name']; ?>"><?php echo $users[$index]['first_name'] . ' ' . $users[$index]['last_name']; ?></option>
                                            <?php } else { ?>
                                                <option value="<?php echo $users[$index]['first_name'] . ' ' . $users[$index]['last_name']; ?>"><?php echo $users[$index]['first_name'] . ' ' . $users[$index]['last_name']; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                    <!--</div>-->
                                                ...
                                                if (isset($data)) {
                                                    ...
                                                    for ($index = 0; $index < count($data); $index++) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="edit-invoice.php?invoice_id=<?php echo $data[$index]['invoice_number']; ?>&user=<?php echo $_GET['user']; ?>&course=<?php echo $_GET['course']; ?>"><?php echo $data[$index]['invoice_no']; ?></a></td>
...
<![endif]-->
        ...
        <script type="text/javascript">
                                        function getData() {
                                            if ($('#course').val() && $('#user').val())
                                                window.location.replace("?course=" + $('#course').val() + "&user=" + $('#user').val());
                                        }
//                                        function selectDate() {
//                                            if ($('#course').val())
